...
public:
	CFifo();
	void Reset(){ overflow = underflow = false; }
	int  GetNumChar();
...
const BYTE DispArr[16] = {0x3f, 0x06, 0x5b, 0x4f, 0x66, 0x6d, 0x7d, 0x07, 0x7f, 0x6f, 0x77, 0x7c, 0x39, 0x5e, 0x79, 0x71};

const BYTE KeyMap[36]  = {0xbb, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 
						  0xff, 0xff, 0xff, 0xbb, 0xff, 0x08,
						  0x09, 0x0a, 0x0b, 0x11, 0xff, 0xff, 
						  0xff, 0xff, 0xff, 0x04, 0x05, 0x06,
						  0x07, 0x12, 0xff, 0xff, 0xff, 0xff,
						  0xff, 0x00, 0x01, 0x02, 0x03, 0x13};
