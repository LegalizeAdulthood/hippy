...
static char *codes[0x100] = {
		0, "NOP", 0,0,0,0,"TAP", "TPA", "INX","DEX", "CLV", "SEV", "CLC", "SEC", "CLI", "SEI", "SBA", "CBA", 0,0,
		0,0,"TAB", "TBA", 0, "DAA", 0, "ABA", 0,0,0,0,"BRA", 0, "BHI", "BLS" , "BCC", "BCS", "BNE", "BEQ", "BVC", 
		"BVS", "BPL", "BMI", "BGE", "BLT", "BGT", "BLE", "TSX", "INS", "PULA", "PULB", "DES", "TXS", "PSHA", "PSHB", 0,
		"RTS", 0, "RTI", 0,0,"WAI", "SWI", "NEGA", 0,0,"COMA", "LSRA", 0, "RORA", "ASRA","ASLA", 
		"ROLA", "DECA", 0, "INCA", "TSTA", 0, "CLRA", "NEGB", 0,0, "COMB", "LSRB", 0, "RORB", "ASRB",
		"ASLB", "ROLB", "DECB", 0, "INCB", "TSTB", 0, "CLRB", "NEG", 0, 0, "COM", "LSR", 0, "ROR", 
		"ASR", "ASL", "ROL", "DEC", 0, "INC", "TST", "JMP", "CLR", "NEG", 0, 0, "COM", "LSR", 0, "ROR", 
		"ASR", "ASL", "ROL", "DEC",0 , "INC", "TST", "JMP", "CLR", "SUBA", "CMPA", "SBCA", 0, "ANDA", "BITA",
		"LDAA", 0, "EORA", "ADCA", "ORAA", "ADDA", "CPX", "BSR", "LDS", 0, "SUBA", "CMPA", "SBCA", 0, "ANDA", 
		"BITA", "LDAA", "STAA", "EORA", "ADCA", "ORAA", "ADDA", "CPXA", 0  ,  "LDS", "STS", "SUBA", "CMPA", "SBCA", 0, "ANDA", 
		"BITA", "LDAA", "STAA", "EORA", "ADCA", "ORAA", "ADDA", "CPX", "JSR", "LDS", "STS", "SUBA", "CMPA", "SBCA", 0, 
		"ANDA", "BITA", "LDAA", "STAA", "EORA", "ADCA", "ORAA", "ADDA", "CPX", "JSR", "LDS", "STS", "SUBB", "CMPB", "SBCB",
		0,"ANDB", "BITB", "LDAB", 0, "EORB", "ADCB", "ORAB", "ADDB", 0,0, "LDX", 0, "SUBB", "CMPB", "SBCB",
		0,"ANDB", "BITB", "LDAB", "STAB", "EORB", "ADCB", "ORAB", "ADDB", 0, 0, "LDX", "STX", "SUBB", "CMPB", "SBCB",
		0,"ANDB", "BITB", "LDAB", "STAB", "EORB", "ADCB", "ORAB", "ADDB", 0, 0, "LDX", "STX", "SUBB", "CMPB", "SBCB",
		0,"ANDB", "BITB", "LDAB", "STAB", "EORB", "ADCB", "ORAB", "ADDB", 0, 0, "LDX", "STX"
	};
...
typedef enum 
{ amNon, amRel, amImp, amInd, amExt, amDir, amImm
} AddressingMode;
