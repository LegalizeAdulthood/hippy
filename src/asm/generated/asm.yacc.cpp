...
/* Line 189 of yacc.c  */
#line 1 "C:/Code/legalize/hippy/hippy/src/asm/asm.y"
...
static const yytype_uint8 yyprhs[] =
{
      ...
      22,    24,    26,    30,    35,    39,    44,    50,    53,    58,
      62,    68,    72,    75,    79,    82,    86,    92,    96,   100,
     104,   107,   113,   118,   122,   126,   129,   132,   133,   138,
     140,   142,   143,   148,   152,   155,   157,   160,   161,   163,
     165,   167,   169,   171,   173,   177,   181,   185,   189,   191,
     193
};
...
{
      35,     0,    -1,    36,    -1,    37,    36,    -1,    -1,    49,
      30,    -1,    49,    38,    -1,    49,    39,    -1,    40,    -1,
      41,    -1,    42,    -1,    43,    -1,    49,    23,    30,    -1,
      24,    31,    24,    30,    -1,    24,    24,    30,    -1,    24,
      24,    23,    30,    -1,    24,    31,    24,    23,    30,    -1,
      22,    30,    -1,    22,    32,    53,    30,    -1,    22,    53,
      30,    -1,    22,    23,    33,     3,    30,    -1,    11,    23,
      30,    -1,    51,    44,    -1,    51,    25,    30,    -1,    50,
      46,    -1,    52,    23,    30,    -1,    21,    23,    33,    23,
      30,    -1,    19,    23,    30,    -1,     8,    23,    30,    -1,
       9,    25,    30,    -1,    10,    30,    -1,    24,    31,    18,
      53,    30,    -1,    24,    18,    53,    30,    -1,    18,    53,
      30,    -1,    14,    25,    30,    -1,    20,    30,    -1,    17,
      48,    -1,    -1,    53,    45,    33,    44,    -1,    53,    -1,
      53,    -1,    -1,    53,    47,    33,    46,    -1,    24,    33,
      48,    -1,    24,    30,    -1,    24,    -1,    24,    31,    -1,
      -1,     5,    -1,    15,    -1,     4,    -1,     6,    -1,     7,
      -1,    16,    -1,    53,    26,    53,    -1,    53,    27,    53,
      -1,    53,    28,    53,    -1,    53,    29,    53,    -1,    54,
      -1,    24,    -1,    23,    -1
};
...
{
  "$end", "error", "$undefined", "INDEX", "FCB", "FDB", "DFB", "RMB",
  "ZMB", "FCC", "END", "ORG", "DFL", "DWL", "NAM", "DWM", "DFS", "OPT",
  "EQU", "BSZ", "PAGE", "FILL", "INST", "NUMBER", "ID", "TEXT", "'+'",
  "'-'", "'*'", "'/'", "'\\n'", "':'", "'#'", "','", "$accept", "program",
  "asm_stmts", "asm_stmt", "pure_asm_stmt", "dir_stmt", "equ_stmt",
  "nam_stmt", "page_stmt", "opt_stmt", "byte_list", "$@1", "word_list",
  "$@2", "id_list", "label_def", "fdb", "fcb", "rmb", "expr",
  "simple_expr", 0
};
#endif
...
static const yytype_uint8 yyr1[] =
{
      ...
      39,    40,    40,    40,    41,    42,    43,    45,    44,    44,
      46,    47,    46,    48,    48,    49,    49,    49,    50,    50,
...
{
      47,     0,     0,     0,     0,    45,     0,     2,    47,     8,
       9,    10,    11,     0,     0,     0,    36,    60,    59,     0,
      58,    35,     0,     0,    46,     1,     3,    50,    48,    51,
      52,     0,     0,     0,     0,    49,    53,     0,     0,     0,
       0,     5,     6,     7,     0,     0,     0,    34,    44,     0,
       0,     0,     0,     0,    33,     0,     0,    14,     0,     0,
       0,     0,    30,     0,     0,     0,    60,    17,     0,     0,
      12,    24,    40,     0,    22,    39,     0,    43,    54,    55,
      56,    57,    32,    15,     0,     0,    13,    28,    29,    21,
      27,     0,     0,     0,    19,     0,    23,     0,    25,    31,
      16,     0,     0,    18,     0,     0,    26,    20,    42,    38
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     6,     7,     8,    42,    43,     9,    10,    11,    12,
      74,    97,    71,    95,    16,    13,    44,    45,    46,    72,
      20
};
...
{
      13,   -13,    -8,   -22,    16,    -7,    23,   -23,    13,   -23,
     -23,   -23,   -23,    -1,    27,    29,   -23,   -23,   -23,    41,
     -23,   -23,   -22,     5,    42,   -23,   -23,   -23,   -23,   -23,
     -23,    38,    39,    65,    73,   -23,   -23,    74,    75,     2,
      70,   -23,   -23,   -23,   -22,    69,    76,   -23,   -23,    -8,
     -22,   -22,   -22,   -22,   -23,    46,    71,   -23,   -22,    33,
      77,    78,   -23,    79,    80,    72,    81,   -23,   -22,    51,
     -23,   -23,    12,    82,   -23,    25,    83,   -23,    15,    15,
     -23,   -23,   -23,   -23,    56,    85,   -23,   -23,   -23,   -23,
     -23,    88,   100,    61,   -23,    84,   -23,    86,   -23,   -23,
     -23,    90,    91,   -23,   -22,   -22,   -23,   -23,   -23,   -23
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -23,   -23,    96,   -23,   -23,   -23,   -23,   -23,   -23,   -23,
       1,   -23,    14,   -23,    67,   -23,   -23,   -23,   -23,    -3,
     -23
};
...
{
      19,    17,    18,    27,    28,    29,    30,    31,    32,    33,
      34,    22,    14,    -4,    35,    36,    15,    23,    37,    55,
      38,    39,    40,    25,    24,    66,    18,     1,    56,    41,
       2,     3,    67,     4,    68,    57,    69,     5,    50,    51,
      52,    53,    75,    52,    53,   -41,    21,    78,    79,    80,
      81,    50,    51,    52,    53,    84,    85,    47,   -37,    48,
      58,    60,    49,    86,    61,    93,    59,    50,    51,    52,
      53,    54,    50,    51,    52,    53,    82,    50,    51,    52,
      53,    94,    50,    51,    52,    53,    99,    50,    51,    52,
      53,   103,    17,    18,    73,    62,    63,    64,    65,    76,
      70,    83,    75,   102,    26,    91,   109,    87,    88,    89,
      90,   101,    96,    98,    92,   100,    77,   104,   108,   105,
     106,   107
};

static const yytype_uint8 yycheck[] =
{
       3,    23,    24,     4,     5,     6,     7,     8,     9,    10,
      11,    18,    25,     0,    15,    16,    24,    24,    19,    22,
      21,    22,    23,     0,    31,    23,    24,    14,    23,    30,
      17,    18,    30,    20,    32,    30,    39,    24,    26,    27,
      28,    29,    45,    28,    29,    33,    30,    50,    51,    52,
      53,    26,    27,    28,    29,    58,    23,    30,    33,    30,
      18,    23,    33,    30,    25,    68,    24,    26,    27,    28,
      29,    30,    26,    27,    28,    29,    30,    26,    27,    28,
      29,    30,    26,    27,    28,    29,    30,    26,    27,    28,
      29,    30,    23,    24,    25,    30,    23,    23,    23,    23,
      30,    30,   105,     3,     8,    33,   105,    30,    30,    30,
      30,    23,    30,    30,    33,    30,    49,    33,   104,    33,
      30,    30
};
...
{
       0,    14,    17,    18,    20,    24,    35,    36,    37,    40,
      41,    42,    43,    49,    25,    24,    48,    23,    24,    53,
      54,    30,    18,    24,    31,     0,    36,     4,     5,     6,
       7,     8,     9,    10,    11,    15,    16,    19,    21,    22,
      23,    30,    38,    39,    50,    51,    52,    30,    30,    33,
      26,    27,    28,    29,    30,    53,    23,    30,    18,    24,
      23,    25,    30,    23,    23,    23,    23,    30,    32,    53,
      30,    46,    53,    25,    44,    53,    23,    48,    53,    53,
      53,    53,    30,    30,    53,    23,    30,    30,    30,    30,
      30,    33,    33,    53,    30,    47,    30,    45,    30,    30,
      30,    23,     3,    30,    33,    33,    30,    30,    46,    44
};
...
#line 110 "C:/Code/legalize/hippy/hippy/src/asm/asm.y"
    {
                ...
                {
                    do_immediate(opcode, get_tkval((yyvsp[(3) - (4)].pse)));
                }
                else
                {
                    if (get_numbytes(opcode) == 3)
                    {
                        store_eqn((yyvsp[(3) - (4)].pse), pc + 1, EXTENDED);
                        do_immediate(opcode, 0x0000);
                    }
                    else
                    {
                        store_eqn((yyvsp[(3) - (4)].pse), pc + 1, ONEBYTE);
...
#line 130 "C:/Code/legalize/hippy/hippy/src/asm/asm.y"
    {
                ...
                else
                {
                    ...
                    {
                        store_eqn((yyvsp[(2) - (3)].pse), pc + 1, EXTENDED);
...
#line 188 "C:/Code/legalize/hippy/hippy/src/asm/asm.y"
    {
                ...
                {
                    if (get_tkval((yyvsp[(1) - (1)].pse)) < 0x100)
                    {
                        memory[pc] = (unsigned char) get_tkval((yyvsp[(1) - (1)].pse));
                        pc++;
                    }
                    else
                ...
                {
                    store_eqn((yyvsp[(1) - (1)].pse), pc, ONEBYTE);
                    pc++;
                }
            ;}
    break;
...
#line 224 "C:/Code/legalize/hippy/hippy/src/asm/asm.y"
    {
                if (get_tktype((yyvsp[(1) - (1)].pse)) == INTEGER)
                {
                    memory[pc] = HI_BYTE(get_tkval((yyvsp[(1) - (1)].pse)));
                    pc++;
                    memory[pc] = LO_BYTE(get_tkval((yyvsp[(1) - (1)].pse)));
                    pc++;
                }
                else
                {
                    store_eqn((yyvsp[(1) - (1)].pse), pc, EXTENDED);
                    pc += 2;
                }
            ;}
    break;
