...
static char *dirList[NUM_DIRECTIVES] = {"FCB", "FDB", "DFB", "RMB", "ZMB", "FCC", "END", "ORG",  "DFL",
                                        "DWL", "NAM", "DWM", "DFS", "OPT", "EQU", "BSZ", "PAGE", "FILL"};

static unsigned int dirHashList[NUM_DIRECTIVES] = {4342598, 4342854, 4343364, 4345170, 4345178,    4408134,
                                                   4476485, 4674127, 4998724, 5003076, 5062990,    5068612,
                                                   5457476, 5525583, 5591365, 5919554, 1162297680, 1280067910};

/*
 * instruction listing
 */
static char *instList[108] = {
    "ASL",  "BMI",  "ASR",  "BLS",  "BNE",  "SEC",  "BLT",  "DAA",  "SEI",  "EORA", "EORB", "NEG",  "SEV",  "TAB",
    "BPL",  "BRA",  "ANDA", "ANDB", "LSR",  "TBA",  "ROL",  "CLC",  "DEC",  "TAP",  "ROR",  "CLI",  "ADCA", "ADCB",
    "LSRA", "LSRB", "ADDA", "ADDB", "BSR",  "CLR",  "DES",  "CLV",  "BVC",  "DEX",  "COMA", "COMB", "RTI",  "COM",
    "PSHA", "PSHB", "ASLA", "BVS",  "ASLB", "RTS",  "STAA", "ROLA", "STAB", "ROLB", "CPX",  "INC",  "DECA", "NOP",
    "DECB", "INS",  "INX",  "ASRA", "ASRB", "RORA", "RORB", "ABA",  "STS",  "TPA",  "STX",  "SUBA", "SUBB", "SWI",
    "ORAA", "ORAB", "JMP",  "TST",  "TSX",  "WAI",  "BCC",  "LDS",  "LDX",  "JSR",  "BCS",  "PULA", "PULB", "TXS",
    "CLRA", "CLRB", "INCA", "INCB", "BEQ",  "BGE",  "LDAA", "LDAB", "CBA",  "BHI",  "BGT",  "NEGA", "NEGB", "SBCA",
    "SBCB", "SBA",  "CMPA", "BITA", "CMPB", "BITB", "BLE",  "TSTA", "TSTB", 0};
